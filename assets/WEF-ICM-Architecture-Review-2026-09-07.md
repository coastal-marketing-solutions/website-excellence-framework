...
**Status:** Advisory. Findings **F-1, F-2, F-3, F-5, F-6, F-7** are implemented on branch `wef-cr-027-intake-and-icm-alignment` (see [`CR-027-DRAFT-Intake-Skill-and-ICM-Alignment.md`](CR-027-DRAFT-Intake-Skill-and-ICM-Alignment.md)) as the artifact the Methodology Governance Board reviews via PR — **not merged to `main`** until approved (Governance Sec. 13.2–13.3). Findings **F-4** and **F-8** are handled as separate follow-up Change Requests — **F-4 → CR-028** ([`CR-028-DRAFT-Revision-Log-Migration.md`](CR-028-DRAFT-Revision-Log-Migration.md); implemented on branch `wef-cr-028-revision-log-migration`, pending Board approval — canonical write-up at [`../WEF-v1.0/_change-requests/CR-028.md`](../WEF-v1.0/_change-requests/CR-028.md)) and **F-8 → CR-029** ([`CR-029-DRAFT-Governance-Chapter-Split.md`](CR-029-DRAFT-Governance-Chapter-Split.md); Board chose **Option C** 2026-09-07 — see [`CR-029-Board-Decision-Memo-Governance-Chapter-Split.md`](CR-029-Board-Decision-Memo-Governance-Chapter-Split.md) — split implemented on branch `wef-cr-029-governance-chapter-split`, reference sweep deferred to [`CR-029-Reference-Sweep-Checklist.md`](CR-029-Reference-Sweep-Checklist.md)) — because each is large enough that folding it into CR-027 would make the PR unreviewable.
...
| 8 | Split `01-Governance.md` into a `01-governance/` sub-folder with its own router | F-8 | **CR-029** | Board chose Option C (2026-09-07); split implemented, reference sweep deferred (tracked) |
