...
| Companion Files | Core Methodology (9 files), Industry Modules (7 files, extensible), Front/Back Matter |
...
- **New engagement teams** should read this Introduction and the entire Core Methodology (all 9 files) before touching an Industry Module. Governance and the Module Integration Standard are not optional scaffolding — they are the mechanism that makes a single methodology work across every industry this firm serves.
