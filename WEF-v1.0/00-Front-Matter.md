...
| 1.0 (Mortgage-Only Release) | 2026-07-23 (AM) | WEF Methodology Group | Published as *Mortgage Website Excellence Framework (MWEF) v1.0* — a single-industry manual. Preserved unmodified in the firm's internal Knowledge Base (not included in this public repository) as a standalone historical reference and as the source material for the Mortgage Lending Industry Module below. |
...
| Companion Files | Core Methodology (10 chapters — chapter 01 is the `01-governance/` folder of 15 section files + a router; chapters 02–10 are single files), Industry Modules (14, extensible), Component Library (6 files, extensible), `_change-requests/` (one file per Change Request), Front/Back Matter |
| Predecessor | *Mortgage Website Excellence Framework (MWEF) v1.0*, preserved intact in the firm's internal Knowledge Base (not included in this public repository) |
...
|---|---|---|---|---|---|
| CR-001 – CR-004 | 2026-06-18 – 2026-07-20 | Various | Pre-re-architecture revision history — recorded in the MWEF v1.0 front matter, held in the firm's internal Knowledge Base (not in this public repository) | Adopted | — |
...
| CR-031 | 2026-09-07 | Front Matter (this row + "Companion Files" counts + §6 + TOC Module list); README.md; Industry Modules — Module-Real-Estate-Luxury-Agent.md; /MWEF-v1.0/ reference wording in Front/Back Matter + Module-Mortgage-Lending.md | Catalog & reference integrity (ICM cleanup pass 2): retroactively recorded the **Real Estate: Luxury Agent Module** (authored 2026-07-30, never logged) and added it to the README tree + TOC; corrected stale file/Module counts (Core Methodology is 10 chapters, chapter 01 now a folder; Industry Modules 13 → 14); reworded ~8 dangling `/MWEF-v1.0/` references (directory removed in `e5b019d`) to point at the firm Knowledge Base | Pending Governance Board approval | [CR-031](_change-requests/CR-031.md) |
| CR-032 | 2026-09-07 | `assets/` (new `README.md` classifier; new `_archive/` — 5 superseded drafts/records moved with banners); `assets/WEF-ICM-Architecture-Review-2026-09-07.md` (status refreshed to RESOLVED); `_change-requests/CR-029.md` + `AGENTS.md` (link fixes) | `assets/` housekeeping (ICM cleanup pass 2): separated live reference from superseded proposal drafts and point-in-time records; nothing deleted | Pending Governance Board approval | [CR-032](_change-requests/CR-032.md) |
...
- Real Estate: Luxury Agent Module
